...
class ModuleArguments:
    ...
    stt: Optional[
        Literal["whisper", "whisper-mlx", "mlx-audio-whisper", "faster-whisper", "parakeet-tdt", "paraformer", "nemotron"]
    ] = field(
    ...
    tts: Optional[Literal["melo", "chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "edge-tts", "omnivoice"]] = field(
        default="qwen3",
        metadata={
